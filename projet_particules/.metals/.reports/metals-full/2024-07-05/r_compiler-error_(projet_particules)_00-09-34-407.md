file://<WORKSPACE>/src/main/scala/app/Main.scala
...
action parameters:
uri: file://<WORKSPACE>/src/main/scala/app/Main.scala
text:
```scala
package app
...
object Main extends JFXApp3 {
  ...
  override def start(): Unit = {
    ...
    def drawParticles(): Unit = {
      
    }

    // Update particle positions and redraw every 16 milliseconds (around 60 FPS)

    def onFrame(now: Long): Unit = {}
  }
